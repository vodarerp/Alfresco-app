-- =============================================================================
-- DIAGNOSTIC: Check DocStaging Table Schema
-- =============================================================================
-- Purpose: Diagnose the NULL Id insertion error
-- Error: "Cannot insert duplicate key row with unique index 'ix_docstaging_id'.
...
PRINT '';
PRINT '=============================================================================';
PRINT 'STEP 2: Check all indexes on DocStaging table';
PRINT '=============================================================================';
...
SELECT TOP 10
    Id, NodeId, Name, DocumentType, Status, CreatedAt
FROM dbo.DocStaging
WHERE Id IS NULL
...
PRINT '';
PRINT '=============================================================================';
PRINT 'STEP 7: Check for common issues with document discovery';
PRINT '=============================================================================';

-- Check how many documents have NULL NodeId (should be 0)
SELECT COUNT(*) AS NullNodeIdCount
FROM dbo.DocStaging
WHERE NodeId IS NULL OR NodeId = '';
...
PRINT '  - NullNodeIdCount should be 0';
