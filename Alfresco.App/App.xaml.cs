...
namespace Alfresco.App
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            AppHost = Host.CreateDefaultBuilder()
                ...
                {                   
                    ...
                    // Named HttpClient for CurrentUserService
                    ...
                    services.AddSingleton<Migration.Abstraction.Interfaces.Wrappers.IPreviewExportService, Migration.Infrastructure.Implementation.Services.PreviewExportService>();
                    services.AddSingleton<Migration.Abstraction.Interfaces.Wrappers.IPreviewFolderRollbackService, Migration.Infrastructure.Implementation.Services.PreviewFolderRollbackService>();
        ...
        private static void LogStartupConfiguration()
        {
            try
            {
                const string appVersion = "5.2.2.1"; // Manual version - update as needed
